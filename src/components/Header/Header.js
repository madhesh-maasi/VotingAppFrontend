...
const Header = ( props ) => {
 ...
 const changeLanguage = (lang) => {
  ...
  useEffect(() => {
    setIsUserLoggedIn(sessionStorage.getItem("auth_token")!==null?true:false);
  ...
  const userName = loginInfo.userName;
	...
	return (
		...
		<span className="font-semibold text-xl tracking-tight">&nbsp;Vote App</span>
		</div>
		<div  className="block lg:hidden" >
		<button onClick={toggleMenu} className="flex items-center px-3 py-2 border rounded text-teal-lighter border-teal-light hover:text-black hover:border-black-100" >
		...
		<li  onClick={()=>changeLanguage('en')} value="en" className="rounded-t bg-gray-200 hover:bg-indigo-400 py-3 px-8 block whitespace-no-wrap" >English</li>
		<li  onClick={()=>changeLanguage('Swedish')} value="swedish" className="rounded-t bg-gray-200 hover:bg-indigo-400 py-3 px-8 block whitespace-no-wrap" >Swedish</li>
		...
		<Link to="/login" onClick={()=>Logout()} className="block px-3 py-2 rounded-md text-sm font-medium text-black mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:bg-gray-800 hover:text-white mr-4">
		...
		<div className={!openMenu?'hidden':'w-full block flex-grow lg:flex lg:items-center lg:w-auto'} >
		<div className="text-sm lg:flex-grow">
		...
		<ul className="dropdown-menu absolute hidden text-black border-indigo-400 pt-1 pl-5">
		<li  onClick={()=>changeLanguage('en')} value="en" className="rounded-t bg-gray-200 hover:bg-indigo-400 py-3 px-8 block whitespace-no-wrap" >English</li>
		<li  onClick={()=>changeLanguage('Spanish')} value="spanish" className="rounded-t bg-gray-200 hover:bg-indigo-400 py-3 px-8 block whitespace-no-wrap" >Spanish</li>
  ...
  <div className="w-full hidden block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <div>
		  ...
		  <a href="#responsive-header" className="block px-3 py-2 rounded-md text-sm font-medium text-black mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:bg-gray-800 hover:text-white mr-4">
